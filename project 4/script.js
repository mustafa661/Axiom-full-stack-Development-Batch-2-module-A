...
function calculate() {
    ...
    // Execute Fetch API
    fetch(`https://v6.exchangerate-api.com/v6/c92c9044da17b91280d1085b/latest/${baseCode}`)
        .then( res => res.json() )
        .then( data => {
            // Get the exchange rate for base currecy to target currency
